...
namespace SGBank.UI.Workflows
{
    public class DepositWorkflow
    {
        ...
        /// constructor
        /// </summary>
        /// <param name="account">account retrieved to deposit money in</param>
        ...
        /// <summary>
        /// get the amount to deposit and process the deposit.
        /// </summary>
        public void Execute()
        {
        ...
        /// <summary>
        /// prompt the user for the amount and verify valid decimal value
        /// </summary>
